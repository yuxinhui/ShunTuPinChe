...
public class OwenrVerifySeletePhoto5 {
    private IHeaderView5 iHeaderView5;
    private Context context;

    public OwenrVerifySeletePhoto5(IHeaderView5 iHeaderView5, Context context) {
        this.iHeaderView5 = iHeaderView5;
    ...
    public void setView(Intent date) {
        ...
        iHeaderView5.setHeaderBitmap5(bitmap);
    }
}
