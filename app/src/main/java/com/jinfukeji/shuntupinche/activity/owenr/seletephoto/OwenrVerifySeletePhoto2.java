...
public class OwenrVerifySeletePhoto2 {
    private IHeaderView2 iHeaderView2;
    private Context context;

    public OwenrVerifySeletePhoto2(IHeaderView2 iHeaderView2, Context context) {
        this.iHeaderView2 = iHeaderView2;
    ...
    public void setView(Intent date) {
        ...
        iHeaderView2.setHeaderBitmap2(bitmap);
    }
}
