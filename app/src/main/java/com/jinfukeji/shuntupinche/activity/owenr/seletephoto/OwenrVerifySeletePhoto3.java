...
public class OwenrVerifySeletePhoto3 {
    private IHeaderView3 iHeaderView3;
    private Context context;

    public OwenrVerifySeletePhoto3(IHeaderView3 iHeaderView3, Context context) {
        this.iHeaderView3 = iHeaderView3;
    ...
    public void setView(Intent date) {
        ...
        iHeaderView3.setHeaderBitmap3(bitmap);
    }
}
