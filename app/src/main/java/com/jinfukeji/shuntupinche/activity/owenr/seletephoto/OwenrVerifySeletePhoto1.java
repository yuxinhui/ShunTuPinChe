...
public class OwenrVerifySeletePhoto1 {
    private IHeaderView1 iHeaderView1;
    private Context context;

    public OwenrVerifySeletePhoto1(IHeaderView1 iHeaderView1, Context context) {
        this.iHeaderView1 = iHeaderView1;
    ...
    public void setView(Intent date) {
        ...
        iHeaderView1.setHeaderBitmap1(bitmap);
    }
}
