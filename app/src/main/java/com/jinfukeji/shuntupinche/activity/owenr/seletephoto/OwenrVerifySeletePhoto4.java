...
public class OwenrVerifySeletePhoto4 {
    private IHeaderView4 iHeaderView4;
    private Context context;

    public OwenrVerifySeletePhoto4(IHeaderView4 iHeaderView4, Context context) {
        this.iHeaderView4 = iHeaderView4;
    ...
    public void setView(Intent date) {
        ...
        iHeaderView4.setHeaderBitmap4(bitmap);
    }
}
